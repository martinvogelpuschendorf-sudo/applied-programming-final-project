...
**Specification:** Defines `self.TARGET_BYTES = 4608` (32 channels × 18 samples × 8 bytes) as the strict data alignment threshold for incoming packages.
...
**What it does:** This must be called inside your `QTimer` loop. It drains all raw binary data currently pooled inside the network socket buffer.
